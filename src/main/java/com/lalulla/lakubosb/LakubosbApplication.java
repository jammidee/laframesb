 ...
 * 
 * LaKuboSb Framework is distributed under the terms of the GNU General Public License 
 * as published by the Free Software Foundation, either version 3 of the License, or
 * (at your option) any later version.
 * 
 * LaKuboSb System is distributed in the hope that it will be useful, but WITHOUT ANY
...
public class LakubosbApplication {
	...
	public static void main(String[] args) {
		SpringApplication.run(LakubosbApplication.class, args);
	}
